 ...
 */
public class FirstItemActivity extends MainActivity {


    public void initToolbar() {
        Toolbar myToolbar = (Toolbar) findViewById(R.id.my_toolbar);

        myToolbar.setTitle("收件箱");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.nav_shoujianxiang:
                Intent intent = new Intent(FirstItemActivity.this,FirstItemActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_jin:
                Intent intent1 = new Intent(FirstItemActivity.this,MainActivity.class);
                startActivity(intent1);
                break;
            case R.id.nav_seven:
                Intent intent2 = new Intent(FirstItemActivity.this,ThirdItemActivity.class);
